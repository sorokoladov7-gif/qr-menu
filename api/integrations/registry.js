...
const PROVIDERS={
 ...
 poster:{name:'Poster',category:'POS',mode:'api_token',implemented:true},
 ...
 evotor:{name:'Эвотор',category:'POS',mode:'api_token',implemented:true},
 frontol:{name:'Frontol',category:'POS',mode:'adapter',implemented:false},
 frontpad:{name:'FrontPad',category:'POS',mode:'api_secret',implemented:true},
