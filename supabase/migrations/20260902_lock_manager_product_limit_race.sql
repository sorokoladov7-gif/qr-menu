-- QR Menu SaaS: serialize manager product-limit checks.
-- Prevents concurrent product inserts from racing past max_products.
...
begin
  ...
  if tg_op = 'INSERT' then
    ...
    perform pg_advisory_xact_lock(hashtextextended(v_manager_id::text, 1701));
