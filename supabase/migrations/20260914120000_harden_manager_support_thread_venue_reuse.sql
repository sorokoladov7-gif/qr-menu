...
-- Support threads are scoped to the selected venue when the manager provides one.
-- Do not reuse a thread belonging to another venue: managers may operate multiple venues.
