...
function qr(t){var u=location.origin+'/src/pages/guest/menu.html?venue='+encodeURIComponent(S.venue.slug||'')+'&table='+encodeURIComponent(t.number)+'&token='+encodeURIComponent(t.qr||'');try{var q=window.qrcode(0,'M');q.addData(u);q.make();return{url:u,svg:q.createSvgTag({cellSize:4,margin:2,scalable:true})}}catch(e){return{url:u,svg:''}}}
