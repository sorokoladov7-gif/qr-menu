...
function loadHandler(pathname){
  switch(pathname){
    case '/api/integrations/iiko': return require('./providers/iiko');
    case '/api/integrations/pos': return require('./providers/pos');
    case '/api/integrations/saby-presto': return require('./providers/saby-presto');
    case '/api/integrations/poster': return require('./providers/poster');
    case '/api/integrations/syrve': return require('./providers/syrve');
    case '/api/integrations/evotor': return require('./providers/evotor');
    case '/api/integrations/frontpad': return require('./providers/frontpad');
