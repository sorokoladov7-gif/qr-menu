const { json, redirect, randomToken, sha256, pkceChallenge, supabase, callbackUrl } = require('./core');
const { bearer, getManagerUser } = require('../../shared/manager-auth');
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const params = new URLSearchParams({ response_type: 'code', client_id: clientId, state, redirect_uri: redirectUri, code_challenge: codeChallenge, code_challenge_method: 'S256' });
