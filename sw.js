...
async function enhanceHtml(r){
  ...
  if(pathname==='/manager.html' && !/js\\/manager\\/manager-ai\\.js/i.test(text)) extra+='<script src="/js/manager/manager-ai.js?v=1"></script>';
...
self.addEventListener('fetch', e => {
  ...
  const noStore=u.pathname==='/integrations.html' || u.pathname==='/js/manager-hall-ai.js' || u.pathname==='/js/manager/manager-ai.js';
