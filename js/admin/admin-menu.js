...
openProductEditor:function(p){if(!p)return;var v=(this.venues||[]).find(function(x){return x.id===p.venue_id;});this.prodModal={show:true,venueId:p.venue_id,venueName:v?v.name:'',list:[JSON.parse(JSON.stringify(p))],form:{name:'',price:0,category:'main'}};},
